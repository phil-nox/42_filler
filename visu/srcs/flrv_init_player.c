...
/*   Updated: 2019/08/28 05:43:15 by laleta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_init_player_shape(t_player *p)
{
	...
	sfRectangleShape_setOutlineThickness(p->shape_ok, 4.0);
	sfRectangleShape_setOutlineThickness(p->shape_er, 4.0);
